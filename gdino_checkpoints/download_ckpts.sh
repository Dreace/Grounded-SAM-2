...
curl -L -o groundingdino_swint_ogc.pth $swint_ogc_url || { echo "Failed to download checkpoint from $swint_ogc_url"; exit 1; }

# echo "Downloading groundingdino_swinb_cogcoor.pth checkpoint..."
# curl -L -o groundingdino_swinb_cogcoor.pth $swinb_cogcoor_url || { echo "Failed to download checkpoint from $swinb_cogcoor_url"; exit 1; }
